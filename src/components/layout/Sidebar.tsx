...
const Sidebar = ({ isOpen, onClose, currentPage, onPageChange }: SidebarProps) => {
  ...
  // Use effective role hook - automatically handles institute-specific role mapping
  const effectiveRole = useEffectiveRole();
  const userRole = (effectiveRole || 'Student') as 'Student' | 'Parent' | 'Teacher' | 'InstituteAdmin' | 'AttendanceMarker' | 'OrganizationManager';
      ...
      `}>
        ...
        <ScrollArea className="flex-1 px-2 sm:px-3 py-3 sm:py-4">
          <div className="space-y-2">
            ...
            {userRole === 'Teacher' && attendanceItems.length > 0 && (
            ...
            {userRole === 'Teacher' && systemItems.length > 0 && (
