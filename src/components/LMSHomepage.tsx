...
import { ArrowRight, LogIn, MessageCircle, Users, GraduationCap, Building, Sparkles } from "lucide-react";
      ...
      <div className="min-h-screen bg-gradient-to-br from-background via-muted/20 to-primary-light/10 relative overflow-hidden">
        ...
        <div className="absolute inset-0 flex flex-col items-center justify-center px-4">
          ...
          <div className="text-center mb-8 z-10">
            <img alt="SurakshaLMS" className="w-32 md:w-48 h-auto mb-4 animate-fade-in" src="/lovable-uploads/6678135b-8997-4d89-82a1-badde05b90d8.png" />
            <h2 style={{
              animationDelay: '0.5s'
