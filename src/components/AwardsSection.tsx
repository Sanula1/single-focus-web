const AwardsSection = () => {
  ...
  return (
    <div className="py-12 md:py-16 lg:py-20 bg-gradient-to-br from-purple-50 to-blue-50 relative overflow-hidden">
      {/* Background decorative elements matching the reference */}
      <div className="absolute top-10 left-10 w-16 h-16 bg-green-400 rounded-lg transform rotate-45 opacity-20"></div>
      <div className="absolute top-20 right-20 w-8 h-8 bg-blue-500 rounded-full opacity-30"></div>
      <div className="absolute bottom-20 right-10 w-24 h-24 bg-gradient-to-br from-green-400 to-pink-400 rounded-full opacity-20"></div>
      <div className="absolute bottom-10 left-20 w-12 h-6 bg-pink-400 rounded-full opacity-25"></div>
            ...
            >
              ...
              <div className="relative">
                ...
                <div className="absolute inset-0 flex flex-col items-center justify-center text-center">
                  {/* Award Type Badge */}
                  <div className="bg-orange-500 text-white text-xs font-bold px-2 py-1 rounded-full mb-1 shadow-sm">
                    {award.award}
                  </div>
